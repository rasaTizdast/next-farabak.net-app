  ...
  return (
    <>
      ...
      <div className="w-full max-w-[1580px]">
        ...
        <section
          className={cn(
            "from-primary via-secondary to-dark-blue relative mx-auto w-full overflow-hidden rounded-lg bg-linear-to-br py-6 shadow-lg md:rounded-xl md:py-10 lg:py-14"
          )}
        >

...
export default function WarrantyTrackingPage() {
  ...
  // Add useEffect to simulate initial page loading
  useEffect(() => {
  ...
  return (
    <div className="w-full warranty-page font-inherit" style={{ direction: "rtl" }}>
      {pageLoading ? (
        // Loading skeleton
        ...
        <div className="max-w-4xl mx-auto">
          <Row justify="center" className="mb-8 font-inherit">
            <Col xs={24} md={18} lg={16} xl={14} className="font-inherit">
              ...
              <Steps current={currentStep} className="mb-8 warranty-steps font-inherit">

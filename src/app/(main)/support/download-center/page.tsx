...
const DownloadCenterPage = () => {
  return (
    <section className="flex flex-col gap-6">
      <div className="w-full max-w-[800px] overflow-x-hidden rounded-lg bg-white py-4 text-center shadow-[0_4px_10px_rgba(0,0,0,0.1)] md:max-w-[600px]">
        <h3 className="border-third mb-6 border-b-3 px-4 py-2 text-center text-[1.5rem] font-black min-[2000px]:text-[2rem]">
          برنامه رئولینک
        </h3>
        <div className="w-full px-4">
          ...
          <Link
            ...
            className="bg-third xs:hover:bg-dark-blue my-2 inline-block w-[60%] min-w-[130px] rounded-[6px] px-8 py-2 text-white transition-colors duration-300"
          >
          ...
          <Link
            ...
            className="xs:hover:bg-dark-blue mt-5 inline-block w-full rounded-[6px] bg-[#1d1d1d] px-8 py-2 font-light text-white transition-colors duration-300"
          >
